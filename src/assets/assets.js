...
export const workData = [
  {
    ...
    company: "BySay Tech India Pvt Ltd.",
    duration: "2024 - Present",
    description:
      "Full Stack Developer specializing in Java Spring Boot backend development and modern React + Tailwind frontend design, with strong SQL database management skills.",
    color: "purple"
  },
  {
    role: "Full Stack Developer",
    company: "Kaira IT Solution",
    duration: "3 Months",
    description:
      "Developed a Jewellery Shop Management System using C#, .NET, WPF, and Entity Framework. Implemented modules like sales reports, purchase reports, invoice generation, voucher tagging, and billing workflows with MVVM architecture and database integration.",
    color: "pink"
  },
  {
  role: "Learning Phase",
  ...
  duration: "2023 - 2024",
  description:
    "Learned HTML, CSS, JavaScript, Git, and basic frontend development concepts. Practiced UI design and built mini projects to strengthen fundamentals.",
  color: "blue"
}
];
